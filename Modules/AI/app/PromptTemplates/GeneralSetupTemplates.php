...
class GeneralSetupTemplates implements  PromptTemplateInterface
{
    ...
    public function build(?string $context = null, ?string $langCode = null, ?string $description = null, ?array $options = null): string
    {
        ...
        return <<<PROMPT
            ...
            - ALL text values in the JSON (category names, brand names, search_tags, etc.) must be in {$langCode} language.
            - Match the provided options exactly as they appear (they may already be in the correct language).
            - search_tags MUST be in {$langCode} language.
            ...
            3. Extract 3-5 relevant search tags from the name and description in {$langCode} language.
