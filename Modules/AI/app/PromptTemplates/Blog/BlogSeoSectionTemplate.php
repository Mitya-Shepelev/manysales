...
class BlogSeoSectionTemplate implements PromptTemplateInterface
{
    ...
    public function build(?string $context = null, ?string $langCode = null, ?string $description = null, ?array $options = null): string
    {
        ...
        return <<<PROMPT
                ...
                - meta_title and meta_description MUST be written in {$langCode} language.
                - Do not mix languages. Use only {$langCode}.

                Instructions:
                - Optimize meta_title and meta_description for blog content in {$langCode}.
