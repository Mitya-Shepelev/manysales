...
<head>
    ...
    <title>{{ translate('Payment') }} - Paytm</title>
...
<body>
    <div class="payment-container">
        ...
        <div class="payment-body">
            ...
            <div class="loading-text">{{ translate('Redirecting to Paytm') }}...</div>
            <div class="sub-text">{{ translate('Please do not refresh this page') }}</div>
        </div>

        <form method="post" action="<?php echo \Illuminate\Support\Facades\Config::get('paytm_config.PAYTM_TXN_URL') ?>" id="form" style="display: none;">
